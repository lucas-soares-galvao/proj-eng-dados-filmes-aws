...
# Uso: OPENAI_API_KEY=sk-... bash infra/scripts/export_env_local.sh
set -euo pipefail

: "${OPENAI_API_KEY:?Defina OPENAI_API_KEY antes de rodar este script}"
...
ATHENA_S3_OUTPUT=s3://lsg-sa-east-1-bucket-temp-dev/athena-results/
