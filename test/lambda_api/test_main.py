...
class TestMain(unittest.TestCase):
    ...
    @patch("os.getenv")
    def test_lambda_handler_movies(self, mock_getenv, mock_api_key, mock_periods, mock_process_discover, mock_process_genres, mock_glue):
        ...
        result = main.lambda_handler({"type": "movie"}, None)
    ...
    @patch("app.lambda_api.main.get_tmdb_key")
    @patch("os.getenv")
    def test_lambda_handler_tv(self, mock_getenv, mock_api_key, mock_periods, mock_process_discover, mock_process_genres, mock_glue):
        mock_getenv.side_effect = lambda key: {
            "TMDB_SECRET_ARN": "arn",
            "S3_BUCKET_SOR": "bucket",
            "GLUE_ETL_JOB_NAME": "job"
        ...
        result = main.lambda_handler({"type": "tv"}, None)
